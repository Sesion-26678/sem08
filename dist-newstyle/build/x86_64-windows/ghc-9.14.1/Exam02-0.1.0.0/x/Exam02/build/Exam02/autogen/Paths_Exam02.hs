...
-- at runtime using the environment variable Exam02_bindir.
...
-- environment variable Exam02_libdir.
...
-- using the environment variable Exam02_dynlibdir.
...
-- runtime using the environment variable Exam02_datadir.
...
-- using the environment variable Exam02_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b\\Exam02-0.1.0.0-inplace-Exam02"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b\\Exam02-0.1.0.0"
libexecdir = "C:\\cabal\\Exam02-0.1.0.0-inplace-Exam02\\x86_64-windows-ghc-9.14.1-bd8b\\Exam02-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "Exam02_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Exam02_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Exam02_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Exam02_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Exam02_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Exam02_sysconfdir") (\_ -> return sysconfdir)
